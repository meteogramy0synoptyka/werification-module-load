  ...
  var b = "0.4.0",
    ...
    k = function (a, b) {
      ...
      for (var s = 0, t = f.length; s < t; s++)
        "zIndex" in f[s] &&
          (o.push(f[s].zIndex), f[s].zIndex < 0 && (p[f[s].zIndex] = f[s]));
      o.sort(g);
      while (o[l] < 0) {
  ...
  (function () {
      ...
      if (f)
        for (y = 0, z = cl.length; y < z; y++) {
          ...
          if (x.el.id == d.id && x.anim == b) {
            x.percent != e ? (cl.splice(y, 1), (l = 1)) : (k = x),
    ...
    function bw(a) {
      ...
      for (var c = 0, d = a.length; d - 2 > c; c += 2) {
        ...
        d - 4 == c
          ? ((e[0] = { x: +a[c - 2], y: +a[c - 1] }), (e[3] = e[2]))
          : c && (e[0] = { x: +a[c - 2], y: +a[c - 1] }),
          b.push([
            "C",
    ...
    var b,
      ...
      W = { hs: 1, rg: 1 },
      X = /,?([achlmqrstvxz]),?/gi,
      Y = /([achlmrqstvz])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?\s*,?\s*)+)/gi,
    ...
    (a._g = h),
      (a.type =
        h.win.SVGAngle ||
        h.doc.implementation.hasFeature(
    ...
    if (a.type == "VML") {
      var bj = h.doc.createElement("div"),
        bk;
      (bj.innerHTML = '<v:shape adj="1"/>'),
        (bk = bj.firstChild),
        (bk.style.behavior = "url(#default#VML)");
    ...
    (a.getRGB = bt(function (b) {
      ...
      if (b == "none")
        return { r: -1, g: -1, b: -1, hex: "none", toString: bv };
      !W[g](b.toLowerCase().substring(0, 2)) &&
        b.charAt() != "#" &&
        (b = bm(b));
      var c,
        d,
      ...
      if (k) {
        ...
        (k = { r: d, g: e, b: f, toString: bv }),
          (k.hex =
            "#" + (16777216 | f | (e << 8) | (d << 16)).toString(16).slice(1)),
          a.is(h, "finite") && (k.opacity = h);
        return k;
      }
      return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: bv };
    }, a)),
      (a.hsb = bt(function (b, c, d) {
      ...
      (a.parsePathString = bt(function (b) {
        ...
        var c = {
          ...
          d = [];
        a.is(b, E) && a.is(b[0], E) && (d = by(b)),
          d.length ||
            r(b).replace(Y, function (a, b, e) {
              var f = [],
                g = b.toLowerCase();
    ...
    var bx = bt(
      ...
      bD = function (a, b, c, d, e, f, g, h, i, j) {
        ...
        if (z(G) > k) {
          ...
          (F = E + k * (g && F > E ? 1 : -1)),
            (h = C + c * w.cos(F)),
            (i = D + d * w.sin(F)),
            (m = bD(h, i, c, d, e, 0, g, I, J, [F, H, C, D]));
        }
        G = F - E;
        var K = w.cos(E),
          L = w.sin(E),
      ...
      bE = function (a, b, c, d, e, f, g, h, i) {
        ...
        return {
          x:
            A(j, 3) * a + A(j, 2) * 3 * i * c + j * 3 * i * i * e + A(i, 3) * g,
          y:
            A(j, 3) * b + A(j, 2) * 3 * i * d + j * 3 * i * i * f + A(i, 3) * h,
        };
      },
      bF = bt(function (a, b, c, d, e, f, g, h) {
        ...
        z(l) > "1e12" && (l = 0.5),
          ...
          l > 0 &&
            l < 1 &&
            ((q = bE(a, b, c, d, e, f, g, h, l)), p.push(q.x), o.push(q.y)),
          n > 0 &&
            n < 1 &&
            ((q = bE(a, b, c, d, e, f, g, h, n)), p.push(q.x), o.push(q.y)),
          (i = f - 2 * d + b - (h - 2 * f + d)),
          (j = 2 * (d - b) - 2 * (f - d)),
          (k = b - d),
          (l = (-j + w.sqrt(j * j - 4 * i * k)) / 2 / i),
          ...
          n > 0 &&
            ...
            ((q = bE(a, b, c, d, e, f, g, h, n)), p.push(q.x), o.push(q.y));
        return {
          min: { x: y[m](0, p), y: y[m](0, o) },
          max: { x: x[m](0, p), y: x[m](0, o) },
        };
      }),
      bG = (a._path2curve = bt(
        function (a, b) {
              ...
              switch (a[0]) {
                ...
                case "T":
                  (b.qx = b.x + (b.x - (b.qx || b.x))),
                    ...
                    (a = ["C"][n](bC(b.x, b.y, b.qx, b.qy, a[1], a[2])));
                  break;
                case "Q":
                  (b.qx = a[1]),
                    (b.qy = a[2]),
                    (a = ["C"][n](bC(b.x, b.y, a[1], a[2], a[3], a[4])));
                  break;
                case "L":
      ...
      bP = (a._equaliseTransform = function (b, c) {
        ...
        for (; g < d; g++) {
          ...
          if (
            j[0] != k[0] ||
            (j[0].toLowerCase() == "r" && (j[2] != k[2] || j[3] != k[3])) ||
            (j[0].toLowerCase() == "s" && (j[3] != k[3] || j[4] != k[4]))
          )
            return;
          (e[g] = []), (f[g] = []);
        ...
        (b.add = function (a, b, c, d, e, f) {
          ...
          (b.split = function () {
            ...
            var f = -e[0][1],
              g = e[1][1];
            g < 0
              ? ((b.rotate = a.deg(w.acos(g))),
                f < 0 && (b.rotate = 360 - b.rotate))
              : (b.rotate = a.deg(w.asin(f))),
              (b.isSimple =
                !+b.shear.toFixed(9) &&
    ...
    (navigator.vendor == "Apple Computer, Inc." &&
      ((bR && bR[1] < 4) || navigator.platform.slice(0, 2) == "iP")) ||
    (navigator.vendor == "Google Inc." && bR && bR[1] < 8)
      ? (k.safari = function () {
          ...
          return function (a, b, c, d) {
            var e = o && u[b] ? u[b] : b,
              f = function (e) {
                ...
                if (o && u[g](b))
                  for (
                    var l = 0, m = e.targetTouches && e.targetTouches.length;
                    l < m;
                    l++
                  )
          ...
          return function (a, b, c, d) {
            var e = function (a) {
              ...
              var b = h.doc.documentElement.scrollTop || h.doc.body.scrollTop,
                ...
                f = a.clientX + e,
                g = a.clientY + b;
              (a.preventDefault = a.preventDefault || bS),
                (a.stopPropagation = a.stopPropagation || bU);
      ...
      bY = function (a) {
        ...
        while (g--) {
          ...
          h.win.opera && n.removeChild(k),
            ...
            l && eve("drag.over." + f.el.id, f.el, l),
            (b += e),
            (c += d),
            eve(
              "drag.move." + f.el.id,
    ...
    (b$.drag = function (b, c, d, e, f, g) {
      function i(i) {
        ...
        (this._drag.x = i.clientX + k),
          ...
          !bX.length && a.mousemove(bY).mouseup(bZ),
          bX.push({ el: this, move_scope: e, start_scope: f, end_scope: g }),
          c && eve.on("drag.start." + this.id, c),
          b && eve.on("drag.move." + this.id, b),
          d && eve.on("drag.end." + this.id, d),
          eve(
            "drag.start." + this.id,
            f || e || this,
            i.clientX + k,
      ...
      (b$.onDragOver = function (a) {
        a
          ? eve.on("drag.over." + this.id, a)
          : eve.unbind("drag.over." + this.id);
      }),
      (b$.undrag = function () {
        var b = ca.length;
        while (b--)
          ca[b].el == this &&
            (this.unmousedown(ca[b].start),
            ca.splice(b, 1),
      ...
      (k.set = function (b) {
        !a.is(b, "array") &&
          (b = Array.prototype.splice.call(arguments, 0, arguments.length));
        var c = new cs(b);
        this.__set__ && this.__set__.push(c);
        return c;
      }),
    ...
    (k.getElementByPoint = function (a, b) {
      ...
      (b$.getBBox = function (a) {
        ...
        if (a) {
          if (b.dirty || !b.bboxwt)
            (this.realPath = bh[this.type](this)),
              (b.bboxwt = bx(this.realPath)),
              (b.bboxwt.toString = cd),
              (b.dirty = 0);
          return b.bboxwt;
        }
        if (b.dirty || b.dirtyT || !b.bbox) {
          if (b.dirty || !this.realPath)
            (b.bboxwt = 0), (this.realPath = bh[this.type](this));
          (b.bbox = bx(bi(this.realPath, this.matrix))),
            (b.bbox.toString = cd),
            (b.dirty = b.dirtyT = 0);
        }
        return b.bbox;
        ...
        for (var r = 0; r < l + 1; r++) {
          n.data[r * l]
            ...
            : ((p = a.findDotsAtSegment(b, c, d, e, f, g, h, i, r / l)),
              (n.data[r * l] = p)),
            r && (k += A(A(o.x - p.x, 2) + A(o.y - p.y, 2), 0.5));
    ...
    (ck.easeIn = ck["ease-in"] = ck["<"]),
      (ck.easeOut = ck["ease-out"] = ck[">"]),
      (ck.easeInOut = ck["ease-in-out"] = ck["<>"]),
      (ck["back-in"] = ck.backIn),
      (ck["back-out"] = ck.backOut);
    var cl = [],
      cm =
      ...
      cn = function () {
        ...
        for (; c < cl.length; c++) {
          ...
          d.initstatus
            ? ((e =
                ((d.initstatus * d.anim.top - d.prev) / (d.percent - d.prev)) *
                f),
              (d.status = d.initstatus),
              delete d.initstatus,
              d.stop && cl.splice(c--, 1))
            : (d.status =
                (d.prev + (d.percent - d.prev) * (e / f)) / d.anim.top);
          if (e < 0) continue;
          if (e < f) {
            var t = h(e / f);
            for (var u in i)
                ...
                switch (U[u]) {
                  ...
                  case "colour":
                    p =
                      "rgb(" +
                      [
                        co(O(i[u].r + t * f * j[u].r)),
                        co(O(i[u].g + t * f * j[u].g)),
                        co(O(i[u].b + t * f * j[u].b)),
                      ].join(",") +
                      ")";
                    break;
                  case "path":
            ...
            d.next &&
              !d.stop &&
              cr(d.anim, d.el, d.next, null, d.totalOrigin, d.repeat);
          }
        }
    ...
    (b$.animateWith = function (b, c, d, e, f, g) {
      ...
      (b$.onAnimation = function (a) {
        a
          ? eve.on("anim.frame." + this.id, a)
          : eve.unbind("anim.frame." + this.id);
        return this;
      }),
      ...
      (b$.pause = function (a) {
        for (var b = 0; b < cl.length; b++)
          cl[b].el.id == this.id &&
            (!a || cl[b].anim == a) &&
            eve("anim.pause." + this.id, this, cl[b].anim) !== !1 &&
            (cl[b].paused = !0);
        return this;
      }),
      (b$.resume = function (a) {
        for (var b = 0; b < cl.length; b++)
          if (cl[b].el.id == this.id && (!a || cl[b].anim == a)) {
            var c = cl[b];
            eve("anim.resume." + this.id, this, c.anim) !== !1 &&
      ...
      (b$.stop = function (a) {
        for (var b = 0; b < cl.length; b++)
          cl[b].el.id == this.id &&
            (!a || cl[b].anim == a) &&
            eve("anim.stop." + this.id, this, cl[b].anim) !== !1 &&
            cl.splice(b--, 1);
        return this;
      }),
      (b$.toString = function () {
    ...
    var cs = function (a) {
        ...
        if (a)
          for (var b = 0, c = a.length; b < c; b++)
            a[b] &&
              (a[b].constructor == b$.constructor || a[b].constructor == cs) &&
    ...
    (ct.push = function () {
      ...
      for (var c = 0, d = arguments.length; c < d; c++)
        (a = arguments[c]),
          a &&
            (a.constructor == b$.constructor || a.constructor == cs) &&
            ((b = this.items.length),
        ...
        if (f) {
          ...
          var o = f.face.bbox[s](c),
            ...
            t =
              +o[1] +
              (h == "baseline"
                ? o[3] - o[1] + +f.face.descent
                : (o[3] - o[1]) / 2);
          for (var u = 0, v = k.length; u < v; u++) {
            var w = (u && f.glyphs[k[u - 1]]) || {},
              z = f.glyphs[k[u]];
            (l += u ? (w.w || f.w) + ((w.k && w.k[k[u]]) || 0) + f.w * i : 0),
              z &&
                z.d &&
                j.push(
                  this.path(z.d).attr({
          ...
          if (d.type == "path") {
            ...
            if (r != "none") {
              ...
              a._g.doc.getElementById(A)
                ? p[A]++
                : (h.defs.appendChild(
                    q(q("path"), { "stroke-linecap": "round", d: o[r], id: A })
                  ),
                  (p[A] = 1));
              ...
              f
                ? ((s = d._.arrows.startdx * l || 0),
                  (t = a.getTotalLength(k.path) - E * l))
                : ((s = E * l),
                  (t = a.getTotalLength(k.path) - (d._.arrows.enddx * l || 0))),
                (w = {}),
                (w["marker-" + i] = "url(#" + B + ")");
              ...
              f
                ? ((s = d._.arrows.startdx * l || 0),
                  (t = a.getTotalLength(k.path) - s))
                : ((s = 0),
                  (t = a.getTotalLength(k.path) - (d._.arrows.enddx * l || 0))),
                d._.arrows[i + "Path"] &&
                  q(j, { d: Raphael.getSubpath(k.path, s, t) }),
            ...
            if (f[b](o)) {
              ...
              switch (o) {
                ...
                case "target":
                  ...
                  o == "target" && p == "blank"
                    ? u.setAttributeNS(n, "show", "new")
                    : u.setAttributeNS(n, o, p);
                  break;
                case "cursor":
                  i.style.cursor = p;
                  break;
                      ...
                      (function (b) {
                        a._preload(D[1], function () {
                          ...
                          q(b, { width: a, height: c }),
                            q(F, { width: a, height: c }),
                            d.paper.safari();
                        });
                      })(z),
                      d.paper.defs.appendChild(z),
                      (i.style.fill = "url(#" + z.id + ")"),
                      q(i, { fill: "url(#" + z.id + ")" }),
                      (d.pattern = z),
                      d.pattern && s(d);
                    break;
      ...
      (z.prototype = A),
        ...
        (A.remove = function () {
          if (!this.removed) {
            ...
            for (var c in this)
              this[c] =
                typeof this[c] == "function" ? a._removedFactory(c) : null;
            this.removed = !0;
          }
        }),
        (A._getBBox = function () {
        ...
        (A.toBack = function () {
          ...
          b.tagName.toLowerCase() == "a"
            ...
            : b.firstChild != this.node &&
              b.insertBefore(this.node, this.node.parentNode.firstChild),
        ...
        (A.insertAfter = function (b) {
          ...
          c.nextSibling
            ? c.parentNode.insertBefore(this.node, c.nextSibling)
            : c.parentNode.appendChild(this.node),
        ...
        (a._engine.create = function () {
          ...
          (d = d || 0),
            ...
            c == 1
              ? ((h.style.cssText =
                  i + "position:absolute;left:" + d + "px;top:" + e + "px"),
                a._g.doc.body.appendChild(h),
                (j = 1))
              : ((h.style.cssText = i + "position:relative"),
                c.firstChild
        ...
        (a.prototype.renderfix = function () {
          ...
          if (d || e)
            d &&
              ...
              e &&
                ((this._top = (this._top + e) % 1), (b.top = this._top + "px"));
        }),
        ...
        (a.prototype.remove = function () {
          ...
          for (var b in this)
            this[b] =
              typeof this[b] == "function" ? a._removedFactory(b) : null;
        });
      var B = a.st;
      for (var C in A)
        A[b](C) &&
          ...
          if (!!b && !!c) {
            ...
            if (k || g.fillsize) {
              ...
              (v = v && v[0]),
                l.removeChild(v),
                k &&
                  ((t = y(f, h.x(k[0], k[1]), h.y(k[0], k[1]))),
                  (v.position = t.dx * o + n + t.dy * o)),
                g.fillsize &&
                  (v.size = g.fillsize[0] * i(b) + n + g.fillsize[1] * i(c)),
                l.appendChild(v);
            }
        ...
        B = function (e, i) {
          ...
          if (
            ...
            if (i["stroke-dasharray"]) {
              ...
              Q.dashstyle = W[b](i["stroke-dasharray"])
                ? W[i["stroke-dasharray"]]
                : o;
            }
            T && l.appendChild(Q);
          }
          if (t.type == "text") {
            ...
            (p = X.style),
              ...
              (p.fontSize = Z * Y + "px"),
              t.textpath.string &&
                (X.innerHTML = c(t.textpath.string)
                  .replace(/</g, "&#60;")
                  .replace(/&/g, "&#38;")
                  .replace(/\n/g, "<br>"));
            ...
            (f = c(f).replace(a._radial_gradient, function (a, b, c) {
              (l = "radial"),
                b &&
                  ...
                  ((b = d(b)),
                  (c = d(c)),
                  i(b - 0.5, 2) + i(c - 0.5, 2) > 0.25 &&
                    (c =
                      e.sqrt(0.25 - i(b - 0.5, 2)) * ((c > 0.5) * 2 - 1) + 0.5),
                  (m = b + n + c));
              return o;
            })),
            (f = f.split(/\s*\-\s*/));
